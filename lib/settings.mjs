...
export function normalizeSettings(raw) {
  ...
  const model = normalizeModelId(src.model);
  // Accept effort or reasoningEffort alias from older/hand-edited files
  const effort = normalizeEffort(
    Object.prototype.hasOwnProperty.call(src, "effort")
      ? src.effort
      : src.reasoningEffort,
  );
  const defaultCwd =
...
export function mergeSettings(current, patch) {
  ...
  if (
    ...
    next.effort =
      e == null || e === ""
        ? null
        : normalizeEffort(e) ?? current.effort;
  }
